      ...
      <div className="mx-auto flex max-w-[1320px] items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Link
            ...
            className="relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 transition hover:bg-slate-50 shadow-sm"
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#059669] to-[#16A34A] text-sm font-semibold text-white">
                {initials}
              </span>
              ...
              <div className="absolute right-0 mt-3 w-72 rounded-3xl border border-slate-200 bg-white p-3 shadow-xl">
                ...
                <div className="space-y-1">
                  {dropdownItems.map((item) => (
                    ...
                    >
                      <MaterialIcon name={item.icon} className="text-base text-[#059669]" />
                      {item.label}
                    </Link>
                  ))}
                </div>
          ...
          <button
            ...
            className="inline-flex h-10 items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-rose-600 shadow-sm transition hover:bg-rose-50 hover:border-rose-200 cursor-pointer"
            aria-label="Log out"
          >
              ...
              return (
                <Link
                  ...
                  className={`rounded-xl px-3 py-2 text-sm font-medium ${
                    active ? "bg-emerald-50 text-[#059669]" : "text-slate-700"
                  }`}
                >
                  {item.label}
                </Link>
