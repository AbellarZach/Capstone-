    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-900/45 p-4">
      <div className="relative w-full max-w-md rounded-2xl bg-white px-6 pb-6 pt-8 text-center shadow-2xl">
        ...
        <p className="text-lg font-bold text-slate-900 sm:text-xl">
          &ldquo;Kindly prepare the exact amount of PHP 130.00 to avoid inconvenience.&rdquo;
        </p>

        <button
          type="button"
          onClick={onProceed}
          className="mt-6 w-full rounded-xl bg-[#059669] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#047857]"
        >
          Proceed
        </button>
      </div>
